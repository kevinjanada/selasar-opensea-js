...
export class OpenSeaAPI {
    ...
    postOrder(order, retries = 2) {
        return __awaiter(this, void 0, void 0, function* () {
            let json;
            try {
                json = (yield this.post(`${ORDERBOOK_PATH}/orders/post/`, order));
            }
            catch (error) {
    ...
    postAssetWhitelist(tokenAddress, tokenId, email) {
        return __awaiter(this, void 0, void 0, function* () {
            const json = yield this.post(`${API_PATH}/asset/${tokenAddress}/${tokenId}/whitelist/`, {
                email,
            });
            return !!json.success;
        });
    ...
    getOrder(query) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.get(`${ORDERBOOK_PATH}/orders/`, Object.assign({ limit: 1 }, query));
            let orderJSON;
    ...
    getOrders(query = {}, page = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.get(`${ORDERBOOK_PATH}/orders/`, Object.assign({ limit: this.pageSize, offset: (page - 1) * this.pageSize }, query));
            if (ORDERBOOK_VERSION == 0) {
                const json = result;
                return {
    ...
    getAsset({ tokenAddress, tokenId, }, retries = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            let json;
            try {
                json = yield this.get(`${API_PATH}/asset/${tokenAddress}/${tokenId || 0}/`);
            }
            catch (error) {
                _throwOrContinue(error, retries);
                yield delay(1000);
    ...
    getAssets(query = {}, page = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            const json = yield this.get(`${API_PATH}/assets/`, Object.assign({ limit: this.pageSize, offset: (page - 1) * this.pageSize }, query));
            return {
    ...
    getPaymentTokens(query = {}, page = 1, retries = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            let json;
            try {
                json = yield this.get(`${API_PATH}/tokens/`, Object.assign(Object.assign({}, query), { limit: this.pageSize, offset: (page - 1) * this.pageSize }));
            }
            catch (error) {
                _throwOrContinue(error, retries);
                yield delay(1000);
    ...
    getBundle({ slug, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const json = yield this.get(`${API_PATH}/bundle/${slug}/`);
    ...
    getBundles(query = {}, page = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            const json = yield this.get(`${API_PATH}/bundles/`, Object.assign(Object.assign({}, query), { limit: this.pageSize, offset: (page - 1) * this.pageSize }));
            return {
