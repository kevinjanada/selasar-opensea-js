...
import { CHEEZE_WIZARDS_BASIC_TOURNAMENT_ADDRESS, CHEEZE_WIZARDS_BASIC_TOURNAMENT_RINKEBY_ADDRESS, CHEEZE_WIZARDS_GUILD_ADDRESS, CHEEZE_WIZARDS_GUILD_RINKEBY_ADDRESS, CK_ADDRESS, CK_RINKEBY_ADDRESS, DECENTRALAND_ESTATE_ADDRESS, DEFAULT_BUYER_FEE_BASIS_POINTS, DEFAULT_GAS_INCREASE_FACTOR, DEFAULT_MAX_BOUNTY, DEFAULT_SELLER_FEE_BASIS_POINTS, DEFAULT_WRAPPED_NFT_LIQUIDATION_UNISWAP_SLIPPAGE_IN_BASIS_POINTS, ENJIN_COIN_ADDRESS, INVERSE_BASIS_POINT, MANA_ADDRESS, MIN_EXPIRATION_SECONDS, NULL_ADDRESS, NULL_BLOCK_HASH, OPENSEA_FEE_RECIPIENT, OPENSEA_SELLER_BOUNTY_BASIS_POINTS, ORDER_MATCHING_LATENCY_SECONDS, RPC_URL_PATH, SELL_ORDER_BATCH_SIZE, STATIC_CALL_CHEEZE_WIZARDS_ADDRESS, STATIC_CALL_CHEEZE_WIZARDS_RINKEBY_ADDRESS, STATIC_CALL_DECENTRALAND_ESTATES_ADDRESS, STATIC_CALL_TX_ORIGIN_ADDRESS, STATIC_CALL_TX_ORIGIN_RINKEBY_ADDRESS, UNISWAP_FACTORY_ADDRESS_MAINNET, UNISWAP_FACTORY_ADDRESS_RINKEBY, WRAPPED_NFT_FACTORY_ADDRESS_MAINNET, WRAPPED_NFT_FACTORY_ADDRESS_RINKEBY, WRAPPED_NFT_LIQUIDATION_PROXY_ADDRESS_MAINNET, WRAPPED_NFT_LIQUIDATION_PROXY_ADDRESS_RINKEBY, } from "./constants";
...
import { annotateERC20TransferABI, annotateERC721TransferABI, assignOrdersToSides, confirmTransaction, delay, estimateCurrentPrice, estimateGas, getCurrentGasPrice, getNonCompliantApprovalAddress, getOrderHash, getTransferFeeSettings, getWyvernAsset, getWyvernBundle, isContractAddress, makeBigNumber, onDeprecated, orderToJSON, personalSignAsync, promisifyCall, rawCall, sendRawTransaction, validateAndFormatWalletAddress, } from "./utils/utils";
export class OpenSeaPort {
     ...
     *  information
     */
    constructor(provider, apiConfig = {}, wyvernProtocolConfig, logger) {
        var _b;
    ...
    wrapAssets({ assets, accountAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const txHash = yield sendRawTransaction(this.web3, {
                from: accountAddress,
            ...
            yield this._confirmTransaction(txHash, EventType.WrapAssets, "Wrapping Assets");
        });
    }
    /**
    ...
    unwrapAssets({ assets, destinationAddresses, accountAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._confirmTransaction(txHash, EventType.UnwrapAssets, "Unwrapping Assets");
        });
    }
    /**
    ...
    liquidateAssets({ assets, accountAddress, uniswapSlippageAllowedInBasisPoints, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._confirmTransaction(txHash, EventType.LiquidateAssets, "Liquidating Assets");
        });
    }
    /**
    ...
    purchaseAssets({ numTokensToBuy, amount, contractAddress, accountAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._confirmTransaction(txHash, EventType.PurchaseAssets, "Purchasing Assets");
        });
    }
    /**
    ...
    getQuoteFromUniswap({ numTokens, isBuying, contractAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const wrappedNFTFactoryContract = this.web3.eth.contract(WrappedNFTFactory);
            ...
            const wrappedNFTContract = this.web3.eth.contract(WrappedNFT);
            const wrappedNFT = yield wrappedNFTContract.at(wrappedNFTAddress);
            const uniswapFactoryContract = this.web3.eth.contract(UniswapFactory);
            ...
            const uniswapExchangeContract = this.web3.eth.contract(UniswapExchange);
    ...
    wrapEth({ amountInEth, accountAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._confirmTransaction(txHash, EventType.WrapEth, "Wrapping ETH");
        });
    }
    /**
    ...
    unwrapWeth({ amountInEth, accountAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._confirmTransaction(txHash, EventType.UnwrapWeth, "Unwrapping W-ETH");
        });
    }
    /**
    ...
    createBundleBuyOrder({ assets, collection, quantities, accountAddress, startAmount, expirationTime = 0, paymentTokenAddress, sellOrder, referrerAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hashedOrder = Object.assign(Object.assign({}, order), { hash: getOrderHash(order) });
            let signature;
            try {
     ...
     */
    createSellOrder({ asset, accountAddress, startAmount, endAmount, quantity = 1, listingTime, expirationTime = 0, waitForHighestBid = false, englishAuctionReservePrice, paymentTokenAddress, extraBountyBasisPoints = 0, buyerAddress, buyerEmail, }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    createFactorySellOrders({ assets, accountAddress, startAmount, endAmount, quantity = 1, listingTime, expirationTime = 0, waitForHighestBid = false, paymentTokenAddress, extraBountyBasisPoints = 0, buyerAddress, buyerEmail, numberOfOrders = 1, }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (numberOfOrders < 1) {
     ...
     */
    createBundleSellOrder({ bundleName, bundleDescription, bundleExternalLink, assets, collection, quantities, accountAddress, startAmount, endAmount, expirationTime = 0, listingTime, waitForHighestBid = false, englishAuctionReservePrice, paymentTokenAddress, extraBountyBasisPoints = 0, buyerAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    fulfillOrder({ order, accountAddress, recipientAddress, referrerAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._confirmTransaction(transactionHash, EventType.MatchOrders, "Fulfilling order", () => __awaiter(this, void 0, void 0, function* () {
    ...
    cancelOrder({ order, accountAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transactionHash = yield this._wyvernProtocol.wyvernExchange.cancelOrder_.sendTransactionAsync([
                order.exchange,
                order.maker,
                order.taker,
                order.feeRecipient,
            ...
            yield this._confirmTransaction(transactionHash.toString(), EventType.CancelOrder, "Cancelling order", () => __awaiter(this, void 0, void 0, function* () {
                const isOpen = yield this._validateOrder(order);
                return !isOpen;
            }));
        });
     ...
     */
    approveSemiOrNonFungibleToken({ tokenId, tokenAddress, accountAddress, proxyAddress, tokenAbi = ERC721, skipApproveAllIfTokenAddressIn = new Set(), schemaName = WyvernSchemaName.ERC721, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const approvalAllCheck = () => __awaiter(this, void 0, void 0, function* () {
                ...
                const isApprovedForAllRaw = yield rawCall(this.web3ReadOnly, {
                    from: accountAddress,
                    to: contract.address,
            ...
            if (isApprovedForAll == 0) {
                ...
                try {
                    ...
                    yield this._confirmTransaction(txHash, EventType.ApproveAllAssets, "Approving all tokens of this type for trading", () => __awaiter(this, void 0, void 0, function* () {
            ...
            const approvalOneCheck = () => __awaiter(this, void 0, void 0, function* () {
                ...
                let approvedAddr = yield promisifyCall((c) => contract.getApproved.call(tokenId, c));
                ...
                if (!approvedAddr) {
                    approvedAddr = yield getNonCompliantApprovalAddress(contract, tokenId, accountAddress);
                    if (approvedAddr == proxyAddress) {
            ...
            try {
                ...
                yield this._confirmTransaction(txHash, EventType.ApproveAsset, "Approving single token for trading", approvalOneCheck);
                return txHash;
            }
            catch (error) {
                console.error(error);
     ...
     */
    approveFungibleToken({ accountAddress, tokenAddress, proxyAddress, minimumAmount = WyvernProtocol.MAX_UINT_256, }) {
        return __awaiter(this, void 0, void 0, function* () {
            proxyAddress =
                proxyAddress ||
            ...
            yield this._confirmTransaction(txHash, EventType.ApproveCurrency, "Approving currency for trading", () => __awaiter(this, void 0, void 0, function* () {
    ...
    unapproveFungibleToken({ accountAddress, tokenAddress, proxyAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._confirmTransaction(txHash, EventType.UnapproveCurrency, "Resetting Currency Approval", () => __awaiter(this, void 0, void 0, function* () {
                const newlyApprovedAmount = yield this._getApprovedTokenCount({
                    accountAddress,
                    tokenAddress,
                    proxyAddress,
    ...
    getCurrentPrice(order) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentPrice = yield this._wyvernProtocolReadOnly.wyvernExchange.calculateCurrentPrice_.callAsync([
                order.exchange,
                order.maker,
                order.taker,
                order.feeRecipient,
    ...
    isAssetTransferrable({ asset, fromAddress, toAddress, quantity, useProxy = false, }, retries = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const gas = yield estimateGas(this._getClientsForRead(retries).web3, {
                    from,
                    to: abi.target,
                    data,
                });
    ...
    transfer({ fromAddress, toAddress, asset, quantity = 1, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._confirmTransaction(txHash, EventType.TransferOne, `Transferring asset`);
            return txHash;
        });
    }
    /**
     ...
     * @returns Transaction hash
     */
    transferAll({ assets, fromAddress, toAddress, schemaName = WyvernSchemaName.ERC721, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._confirmTransaction(txHash, EventType.TransferAll, `Transferring ${assets.length} asset${assets.length == 1 ? "" : "s"}`);
            return txHash;
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (schema.functions.countOf) {
                ...
                const inputValues = abi.inputs
                    ...
                    .map((x) => x.value);
                const count = yield promisifyCall((c) => contract[abi.name].call(accountAddress, ...inputValues, c));
                if (count !== undefined) {
                    return count;
                }
            }
                ...
                const owner = yield promisifyCall((c) => contract[abi.name].call(...inputValues, c));
                if (owner) {
     ...
     */
    getTokenBalance({ accountAddress, tokenAddress, schemaName = WyvernSchemaName.ERC20, }, retries = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            const asset = {
                tokenId: null,
                tokenAddress,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (side == OrderSide.Sell && asset) {
                ...
                try {
                    ...
                    const result = yield getTransferFeeSettings(this.web3, {
                        asset,
                        accountAddress,
                    });
                    transferFee =
            ...
            const bountyTooLarge = sellerBountyBasisPoints + OPENSEA_SELLER_BOUNTY_BASIS_POINTS >
                maxTotalBountyBPS;
    ...
    validateAndPostOrder(order) {
        return __awaiter(this, void 0, void 0, function* () {
            const hash = yield this._wyvernProtocolReadOnly.wyvernExchange.hashOrder_.callAsync([
                order.exchange,
                order.maker,
                order.taker,
                order.feeRecipient,
            ...
            const confirmedOrder = yield this.api.postOrder(orderToJSON(order));
    ...
    _computeGasPrice() {
        return __awaiter(this, void 0, void 0, function* () {
            const meanGas = yield getCurrentGasPrice(this.web3);
     ...
     */
    _estimateGasForMatch({ buy, sell, accountAddress, metadata = NULL_BLOCK_HASH, }, retries = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            let value;
            ...
            try {
                return yield this._getClientsForRead(retries).wyvernProtocol.wyvernExchange.atomicMatch_.estimateGasAsync([
                    buy.exchange,
                    buy.maker,
                    buy.taker,
                    buy.feeRecipient,
     ...
     */
    _estimateGasForTransfer({ assets, fromAddress, toAddress, schemaName = WyvernSchemaName.ERC721, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const schemaNames = assets.map((asset) => asset.schemaName || schemaName);
            const wyAssets = assets.map((asset) => getWyvernAsset(this._getSchema(asset.schemaName), asset));
            const proxyAddress = yield this._getProxy(fromAddress);
    ...
    _getProxy(accountAddress, retries = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            let proxyAddress = yield this._wyvernProtocolReadOnly.wyvernProxyRegistry.proxies.callAsync(accountAddress);
            if (proxyAddress == "0x") {
    ...
    _initializeProxy(accountAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transactionHash = yield this._wyvernProtocol.wyvernProxyRegistry.registerProxy.sendTransactionAsync(Object.assign(Object.assign({}, txnData), { gas: this._correctGasAmount(gasEstimate) }));
            yield this._confirmTransaction(transactionHash, EventType.InitializeAccount, "Initializing proxy for account", () => __awaiter(this, void 0, void 0, function* () {
    ...
    _getApprovedTokenCount({ accountAddress, tokenAddress, proxyAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const addressToApprove = proxyAddress ||
                WyvernProtocol.getTokenTransferProxyAddress(this._networkName);
            const approved = yield rawCall(this.web3, {
                from: accountAddress,
                to: tokenAddress,
    ...
    _makeBuyOrder({ asset, quantity, accountAddress, startAmount, expirationTime = 0, paymentTokenAddress, extraBountyBasisPoints = 0, sellOrder, referrerAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { basePrice, extra, paymentToken } = yield this._getPriceParameters(OrderSide.Buy, paymentTokenAddress, expirationTime, startAmount);
    ...
    _makeSellOrder({ asset, quantity, accountAddress, startAmount, endAmount, listingTime, expirationTime, waitForHighestBid, englishAuctionReservePrice = 0, paymentTokenAddress, extraBountyBasisPoints, buyerAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            accountAddress = validateAndFormatWalletAddress(this.web3, accountAddress);
            const schema = this._getSchema(asset.schemaName);
            const quantityBN = WyvernProtocol.toBaseUnitAmount(makeBigNumber(quantity), asset.decimals || 0);
            ...
            const orderSaleKind = endAmount != null && endAmount !== startAmount
                ...
                : SaleKind.FixedPrice;
            const { basePrice, extra, paymentToken, reservePrice } = yield this._getPriceParameters(OrderSide.Sell, paymentTokenAddress, expirationTime, startAmount, endAmount, waitForHighestBid, englishAuctionReservePrice);
    ...
    _getStaticCallTargetAndExtraData({ asset, useTxnOriginStaticCall, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isCheezeWizards) {
                ...
                const cheezeWizardsBasicTournamentABI = this.web3.eth.contract(CheezeWizardsBasicTournament);
                const cheezeWizardsBasicTournmentInstance = yield cheezeWizardsBasicTournamentABI.at(cheezeWizardsBasicTournamentAddress);
                const wizardFingerprint = yield rawCall(this.web3, {
                ...
                const decentralandEstateABI = this.web3.eth.contract(DecentralandEstates);
                const decentralandEstateInstance = yield decentralandEstateABI.at(decentralandEstateAddress);
                const estateFingerprint = yield rawCall(this.web3, {
    ...
    _makeBundleSellOrder({ bundleName, bundleDescription, bundleExternalLink, assets, collection, quantities, accountAddress, startAmount, endAmount, listingTime, expirationTime, waitForHighestBid, englishAuctionReservePrice = 0, paymentTokenAddress, extraBountyBasisPoints, buyerAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            accountAddress = validateAndFormatWalletAddress(this.web3, accountAddress);
            const quantityBNs = quantities.map((quantity, i) => WyvernProtocol.toBaseUnitAmount(makeBigNumber(quantity), assets[i].decimals || 0));
            const bundle = getWyvernBundle(assets, assets.map((a) => this._getSchema(a.schemaName)), quantityBNs);
    ...
    _makeMatchingOrder({ order, accountAddress, recipientAddress, }) {
        ...
        return Object.assign(Object.assign({}, matchingOrder), { hash: getOrderHash(matchingOrder) });
    }
    /**
    ...
    _validateMatch({ buy, sell, accountAddress, shouldValidateBuy = false, shouldValidateSell = false, }, retries = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const canMatch = yield requireOrdersCanMatch(this._getClientsForRead(retries).wyvernProtocol, { buy, sell, accountAddress });
                this.logger(`Orders matching: ${canMatch}`);
                const calldataCanMatch = yield requireOrderCalldataCanMatch(this._getClientsForRead(retries).wyvernProtocol, { buy, sell });
    ...
    _sellOrderValidationAndApprovals({ order, accountAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sellValid = yield this._wyvernProtocolReadOnly.wyvernExchange.validateOrderParameters_.callAsync([
                order.exchange,
                order.maker,
                order.taker,
                order.feeRecipient,
    ...
    _approveOrder(order) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transactionHash = yield this._wyvernProtocol.wyvernExchange.approveOrder_.sendTransactionAsync([
                order.exchange,
                order.maker,
                order.taker,
                order.feeRecipient,
            ...
            yield this._confirmTransaction(transactionHash.toString(), EventType.ApproveOrder, "Approving order", () => __awaiter(this, void 0, void 0, function* () {
    ...
    _validateOrder(order) {
        return __awaiter(this, void 0, void 0, function* () {
            const isValid = yield this._wyvernProtocolReadOnly.wyvernExchange.validateOrder_.callAsync([
                order.exchange,
                order.maker,
                order.taker,
                order.feeRecipient,
    ...
    _buyOrderValidationAndApprovals({ order, counterOrder, accountAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const tokenAddress = order.paymentToken;
            if (tokenAddress != NULL_ADDRESS) {
                const balance = yield this.getTokenBalance({
                    accountAddress,
                    tokenAddress,
                });
            ...
            const buyValid = yield this._wyvernProtocolReadOnly.wyvernExchange.validateOrderParameters_.callAsync([
                order.exchange,
                order.maker,
                order.taker,
                order.feeRecipient,
    ...
    _atomicMatch({ buy, sell, accountAddress, metadata = NULL_BLOCK_HASH, }) {
        return __awaiter(this, void 0, void 0, function* () {
            let value;
            ...
            try {
                ...
                const gasEstimate = yield this._wyvernProtocolReadOnly.wyvernExchange.atomicMatch_.estimateGasAsync(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], txnData);
            ...
            try {
                ...
                txHash =
                    yield this._wyvernProtocol.wyvernExchange.atomicMatch_.sendTransactionAsync(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], txnData);
            }
            catch (error) {
                console.error(error);
                this._dispatch(EventType.TransactionDenied, {
    ...
    _authorizeOrder(order) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const makerIsSmartContract = yield isContractAddress(this.web3, signerAddress);
            try {
                if (makerIsSmartContract) {
                    ...
                    return yield personalSignAsync(this.web3, message, signerAddress);
                }
            }
            catch (error) {
    ...
    _confirmTransaction(transactionHash, event, description, testForSuccess) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield confirmTransaction(this.web3, transactionHash);
                this.logger(`Transaction succeeded: ${description}`);
                this._dispatch(EventType.TransactionConfirmed, transactionEventData);
            }
            catch (error) {
                this.logger(`Transaction failed: ${description}`);
                this._dispatch(EventType.TransactionFailed, Object.assign(Object.assign({}, transactionEventData), { error }));
                throw error;
            }
        });
    }
