...
var OpenSeaPort = /** @class */ (function () {
     ...
     *  information
     */
    function OpenSeaPort(provider, apiConfig, wyvernProtocolConfig, logger) {
        ...
        */
        this.wyvernProtocolConfig = wyvernProtocolConfig;
        this._wyvernProtocol = new wyvern_js_1.WyvernProtocol(provider, wyvernProtocolConfig);
        this._wyvernProtocolReadOnly = new wyvern_js_1.WyvernProtocol(provider, wyvernProtocolConfig);
    ...
    OpenSeaPort.prototype.createSellOrder = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var order, err_1, hash, hashedOrder, signature, error_3, orderWithSignature;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        throw err_1;
                    case 5:
                        console.log("_sellOrderValidationAndApprovals success");
                        if (!buyerEmail) return [3 /*break*/, 7];
                    ...
                    case 7:
                        hash = "";
                        try {
                            hash = (0, utils_1.getOrderHash)(order);
                        }
                        catch (err) {
                            console.log("Error at getOrderHash");
                            console.log(err);
                            throw err;
                        }
                        hashedOrder = __assign(__assign({}, order), { 
                    ...
                    case 0:
                        proxyAddress =
                            proxyAddress ||
                                ...
                                this.wyvernProtocolConfig.wyvernTokenTransferProxyAddress ||
                                "";
    ...
    OpenSeaPort.prototype.computeFees = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var openseaBuyerFeeBasisPoints, openseaSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, transferFee, transferFeeTokenAddress, maxTotalBountyBPS, result, error_9, sellerBountyBasisPoints, bountyTooLarge, errorMessage, royalties;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 4:
                        ...
                        if (asset && asset.collection) {
                            royalties = asset.collection.royalties;
                        }
                        return [2 /*return*/, {
                                ...
                                totalBuyerFeeBasisPoints: 0,
                                totalSellerFeeBasisPoints: royalties,
                ...
                switch (_k.label) {
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, {
                                ...
                                exchange: this.wyvernProtocolConfig.wyvernExchangeContractAddress || "",
                ...
                switch (_k.label) {
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, {
                                ...
                                target: this.wyvernProtocolConfig.wyvernAtomicizerContractAddress || "",
        ...
        var computeOrderParams = function () {
            if ("asset" in order.metadata) {
                ...
                return {
                    ...
                    //  this._networkName
                    //),
                    target: _this.wyvernProtocolConfig.wyvernAtomicizerContractAddress || "",
    ...
    OpenSeaPort.prototype._sellOrderValidationAndApprovals = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        console.log("in _sellOrderValidationAndApprovals");
                    ...
                    case 4:
                        sellValid = _c.sent();
                        if (!sellValid) {
                            console.log("!sellValid");
                            console.error("failed to validate sell order parameters", order);
                                ...
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        ...
                                        case 7:
                                            ...
                                            console.log("contractsWithApproveAll", contractsWithApproveAll);
                                            return [4 /*yield*/, this.approveFungibleToken({
