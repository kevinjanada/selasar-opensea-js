...
import { FunctionInputKind, FunctionOutputKind, StateMutability, } from "wyvern-schemas/dist/types";
...
export const annotateERC721TransferABI = (asset) => ({
    constant: false,
    inputs: [
        {
            name: "_to",
...
export const annotateERC20TransferABI = (asset) => ({
    constant: false,
    inputs: [
        {
            name: "_to",
...
const track = (web3, txHash, onFinalized) => {
    if (txCallbacks[txHash]) {
        ...
        const poll = () => __awaiter(void 0, void 0, void 0, function* () {
            const tx = yield promisify((c) => web3.eth.getTransaction(txHash, c));
            if (tx && tx.blockHash && tx.blockHash !== NULL_BLOCK_HASH) {
                const receipt = yield promisify((c) => web3.eth.getTransactionReceipt(txHash, c));
                if (!receipt) {
...
export const confirmTransaction = (web3, txHash) => __awaiter(void 0, void 0, void 0, function* () {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const assetBundleFromJSON = (asset_bundle) => {
    const fromJSON = {
 ...
 * @param onError callback when user denies transaction
 */
export function sendRawTransaction(web3, { from, to, data, gasPrice, value = 0, gas }, onError) {
    return __awaiter(this, void 0, void 0, function* () {
        if (gas == null) {
 ...
 * @param onError callback when user denies transaction
 */
export function rawCall(web3, { from, to, data }, onError) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
export function estimateGas(web3, { from, to, data, value = 0 }) {
    return __awaiter(this, void 0, void 0, function* () {
...
export function getCurrentGasPrice(web3) {
    return __awaiter(this, void 0, void 0, function* () {
        const meanGas = yield promisify((c) => web3.eth.getGasPrice(c));
        return meanGas;
    });
}
/**
 ...
 */
export function getTransferFeeSettings(web3, { asset, accountAddress, }) {
    return __awaiter(this, void 0, void 0, function* () {
        let transferFee;
        ...
        if (asset.tokenAddress.toLowerCase() == ENJIN_ADDRESS.toLowerCase()) {
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            const params = yield promisifyCall((c) => feeContract.transferSettings(asset.tokenId, { from: accountAddress }, c));
            if (params) {
 ...
 */
export function estimateCurrentPrice(order, secondsToBacktrack = 30, shouldRoundUp = true) {
 ...
 */
export function getWyvernAsset(schema, asset, quantity = new BigNumber(1)) {
