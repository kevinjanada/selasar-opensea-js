...
var assetFromJSON = function (asset) {
    ...
    var fromJSON = {
        ...
        collection: (0, exports.collectionFromJSON)(asset.collections),
...
var orderFromJSON = function (order) {
    ...
    var fromJSON = {
        ...
        makerRelayerFee: new bignumber_js_1.default(order.makerRelayerFee || 0),
        takerRelayerFee: new bignumber_js_1.default(order.takerRelayerFee || 0),
        makerProtocolFee: new bignumber_js_1.default(order.makerProtocolFee || 0),
        takerProtocolFee: new bignumber_js_1.default(order.takerProtocolFee || 0),
        makerReferrerFee: new bignumber_js_1.default(order.makerReferrerFee || 0),
        waitingForBestCounterOrder: order.feeRecipient ? order.feeRecipient.address == constants_1.NULL_ADDRESS : false,
        feeMethod: order.feeMethod,
        feeRecipientAccount: order.feeRecipient,
        feeRecipient: order.feeRecipient ? order.feeRecipient.address || constants_1.NULL_ADDRESS : constants_1.NULL_ADDRESS,
        side: order.side,
        ...
        extra: new bignumber_js_1.default(order.extra || 0),
        ...
        paymentTokenContract: order.paymentTokenContract
            ? (0, exports.tokenFromJSON)(order.paymentTokenContract)
            : undefined,
        asset: order.asset ? (0, exports.assetFromJSON)(order.asset) : undefined,
        assetBundle: order.assetBundle
            ? (0, exports.assetBundleFromJSON)(order.assetBundle)
            : undefined,
    };
