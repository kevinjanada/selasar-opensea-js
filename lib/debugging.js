 ...
 */
export function requireOrdersCanMatch(client, { buy, sell, accountAddress, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield client.wyvernExchange.ordersCanMatch_.callAsync([
            buy.exchange,
            buy.maker,
            buy.taker,
            buy.feeRecipient,
 ...
 * @param sell Sell Order for debugging
 */
export function requireOrderCalldataCanMatch(client, { buy, sell }) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield client.wyvernExchange.orderCalldataCanMatch.callAsync(buy.calldata, buy.replacementPattern, sell.calldata, sell.replacementPattern);
        if (result) {
            return;
        }
