...
(0, mocha_1.suite)("createSellOrder", function () {
    (0, mocha_1.test)("createSellOrder", function () { return __awaiter(void 0, void 0, void 0, function () {
        var client, listing;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    client = (0, util_1.initTestClient)();
                    return [4 /*yield*/, client.createSellOrder({
                            asset: {
